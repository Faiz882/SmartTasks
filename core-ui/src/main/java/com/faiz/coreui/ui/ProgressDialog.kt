...
import com.faiz.coreui.R
import com.faiz.coreui.databinding.DialogProgressBinding
...
class ProgressDialog : DialogFragment() {
    ...
    private fun setupDialogStyle() {
        ...
        viewBinding?.progressBar?.setIndicatorColor(ContextCompat.getColor(requireContext(),R.color.black))
    }
